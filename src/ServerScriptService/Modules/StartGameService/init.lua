...
function StartGameService:InitBridgeListener()
	bridge.OnServerInvoke = function(player, data)
		if data[actionIdentifier] == "Start" then
			...
			--	PlotService:SetWithPlotNumber(player, 3, "Fluriflura")
			--	PlotService:SetWithPlotNumber(player, 4, "CappuccinoAssassino")
			--	PlotService:SetWithPlotNumber(player, 5, "ChefCrabracadabra")
			--	PlotService:SetWithPlotNumber(player, 6, "TrulimeroTrulicina")
			--	PlotService:SetWithPlotNumber(player, 7, "LirilìLarilà")
			--	PlotService:SetWithPlotNumber(player, 8, "TimCheese")
			--	PlotService:SetWithPlotNumber(player, 9, "GlorboFruttodrillo")
			--	PlotService:SetWithPlotNumber(player, 10, "LaVaccaSaturnoSaturnita")
			--	PlotService:SetWithPlotNumber(player, 11, "TrippiTroppi")

			--	PlotService:SetWithPlotNumber(player, 12, "FrigoCamelo")
			--	PlotService:SetWithPlotNumber(player, 13, "BonecaAmbalabu")
			--	PlotService:SetWithPlotNumber(player, 14, "CavalloVirtuoso")
			--	PlotService:SetWithPlotNumber(player, 15, "ChimpanziniBananini")
			--	PlotService:SetWithPlotNumber(player, 16, "BrrBrrPatapim")
			--	PlotService:SetWithPlotNumber(player, 17, "OdinDinDinDun")
			--	PlotService:SetWithPlotNumber(player, 18, "TaTaTaSahur")
			--	PlotService:SetWithPlotNumber(player, 19, "CocofantoElefanto")
